...
export function AccountButton({ label, open, onClick, icon }: AccountButtonProps) {
  return (
    <button
      ...
      aria-expanded={open}
      aria-haspopup="menu"
      className={`inline-flex min-h-touch items-center gap-2 px-3 py-2 font-ui text-label font-bold uppercase tracking-wide text-tinta transition-colors hover:bg-papel-profundo focus:outline-none focus-visible:ring-2 focus-visible:ring-tinta ${
