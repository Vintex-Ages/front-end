...
export function FooterLink({ text, linkLabel, to, onClick }: FooterLinkProps) {
  const linkClass =
    'font-ui text-body font-bold text-vermelho-escuro no-underline hover:underline bg-transparent border-0 p-0 cursor-pointer focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-vermelho-escuro';
